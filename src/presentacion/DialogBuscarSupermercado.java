...
public class DialogBuscarSupermercado extends javax.swing.JDialog {
    private DefaultTableModel modelo = new DefaultTableModel();
    public Supermercado supermercadoSelec = new Supermercado();
    /**
     * Creates new form DialogBuscarSupermercado
     */
    ...
    private void initComponents() {
        ...
        txtIdSupermercado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtIdSupermercadoActionPerformed(evt);
            }
        });
        txtIdSupermercado.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtIdSupermercadoKeyReleased(evt);
            }
        });
        jPanel1.add(txtIdSupermercado, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 30, 184, -1));
    ...
    private void txtIdSupermercadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtIdSupermercadoActionPerformed

    }//GEN-LAST:event_txtIdSupermercadoActionPerformed

    private void txtIdSupermercadoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIdSupermercadoKeyReleased
        // TODO add your handling code here:
        String idSupermercado=txtIdSupermercado.getText();
        try {
            SupermercadoDAO.getInstancia().mostrarPorNombre(modelo, idSupermercado);
        } catch (SQLException su) {
            JOptionPane.showMessageDialog(null, su.getMessage());
        }
    }//GEN-LAST:event_txtIdSupermercadoKeyReleased

    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        int i = Tabla.getSelectedRow();
        if(i!=-1) {
            
            supermercadoSelec.setIdSupermercado(modelo.getValueAt(i, 0).toString());
            supermercadoSelec.setNombre(modelo.getValueAt(i, 1).toString());
            supermercadoSelec.setDireccion(modelo.getValueAt(i,2).toString());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String idSupermercado=txtIdSupermercado.getText();
        try {
            SupermercadoDAO.getInstancia().buscarSupermercado(idSupermercado);
        } catch (SQLException su) {
            JOptionPane.showMessageDialog(null, su.getMessage());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogBuscarSupermercado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogBuscarSupermercado dialog = new DialogBuscarSupermercado();
