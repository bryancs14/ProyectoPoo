...
public class FrmLoginAdministrador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 240, 30, 30));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/candado_1.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 290, 30, 30));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/id.png"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, 30, 30));
        ...
        getContentPane().add(btnLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 360, 190, 30));

        txtIdAdministrador.setBackground(new java.awt.Color(207, 211, 222));
        txtIdAdministrador.setForeground(new java.awt.Color(127, 132, 138));
        ...
        getContentPane().add(txtIdAdministrador, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 190, 220, 30));
        txtIdAdministrador.setEnabled(true);
        ...
        getContentPane().add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 220, 30));
        ...
        getContentPane().add(txtContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 290, 220, 30));
        txtContraseña.setEnabled(true);

        jPanel3.setBackground(new java.awt.Color(211, 213, 224));
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 290, 260, 30));

        jPanel2.setBackground(new java.awt.Color(211, 213, 224));
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 240, 260, 30));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "DATOS INCORRECTOS" + e.getMessage());
        }
    ...
    private void txtIdAdministradorFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIdAdministradorFocusGained
        String idAministrador = txtIdAdministrador.getText();
        
        if(idAministrador.equalsIgnoreCase("ID ADMINISTRADOR")){
    ...
    private void txtIdAdministradorFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIdAdministradorFocusLost
        ...
        if(idAministrador.equalsIgnoreCase("ID ADMINISTRADOR") || idAministrador.equalsIgnoreCase("")){
            txtIdAdministrador.setText("ID ADMINISTRADOR");
